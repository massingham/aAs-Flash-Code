package com.aA.Mobile.UI.Behaviour 
{
	 ...
	 */
	public class StarlingScrollableItem extends EventDispatcher
	{
		...
		private var scrollbarSprite:Quad;
		
		public function StarlingScrollableItem(item:Sprite , type:String, visibleArea:Point):void {
			this.item = item;
			this.type = type;
		...
		private function addMask(event:Event):void {
			...
			scrollbarSprite = new Quad(10, 1, 0x000000);
